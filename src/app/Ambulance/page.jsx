    ...
    return (
        <>
            ...
            <div style={{
                ...
                <span className="text-sm"><span onClick={() => { router.push("/Home"); }} className="hover:text-red_new hover:cursor-pointer text-white">Home</span> <FontAwesomeIcon icon={faAngleRight} />  Ambulance</span>
            </div >
            ...
            <div className="h-auto w-full bg-white flex justify-center">
                <div className="font-custom w-[85%] md:w-[80%] lg:w-[70%] h-full flex flex-col item-center my-10">
                    {/* Carousel starts */}
                    <div className="mb-10">
                        <span className='w-full text-3xl lg:text-4xl text-[#333] font-bold text-left mt-2 '>Book An Ambulance Instantly</span>
                    ...
                    <div className="flex flex-col space-y-4 py-12">
                        <span className='w-[100%] sm:w-[80%] text-base text-[#757575] font-normal text-left mt-2 '>With HealthKa's mobile app, you can book an ambulance instantly. Our services are designed for rapid response, ensuring you get the help you need without delay. One call is all it takes to have an ambulance dispatched to your location.</span>
                        <span className='block text-lg font-semibold text-[#333]'>Types of Ambulance</span>
