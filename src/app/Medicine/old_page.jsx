  ...
  return (
    <>
      ...
      <div className="bg-white w-full h-[1250px] flex flex-col items-center font-custom text-[#333]">
        <span className="text-4xl mt-16  font-bold">
          All medicine are available |{" "}
          <span className="text-blue_new">order now</span>
        </span>
        ...
        <div className="bg-white w-[95%] h-[1800px] grid grid-cols-4 p-10">
          {Medicines.map((Medicine, index) => (
            <div
              key={index}
              className=" hover:-translate-y-2  transition-transform duration-300 ease-in-out news_hover shadow-lg m-4   rounded-xl h-[300px] w-[300px] flex flex-col items-center"
            >
              <div
                className="rounded-xl h-[55%] w-[55%] m-2 shadow-md"
                style={{
              ...
              <div className=" text-[#333] w-[8rem] pl-4 h-[15%] text-center font-semibold items-center justify-center ">
                <a
                  href="#"
                  className="relative active pb-0.5 h-full flex items-center justify-left"
                >
                  Buy Now{" "}
                  <FontAwesomeIcon
                    className="text-[#333] pl-2"
                    icon={faRightLong}
                  />
                </a>
              </div>
