    ...
    <>
      ...
      >
        ...
        <span className="text-sm">
          ...
          <FontAwesomeIcon icon={faAngleRight} /> Medicine
        </span>
      </div>
        ...
        <div className="font-custom w-[85%] md:w-[80%] lg:w-[70%] h-full flex flex-col item-center my-10">
          ...
          <div className="mb-10">
            <span className="w-full text-3xl lg:text-4xl text-[#333] font-bold text-left mt-2 ">
              Buy Medicine and Get Delivery in 10 Minutes
            </span>
          ...
          <div className="flex flex-col space-y-4 py-12">
            <span className="w-[100%] sm:w-[80%] text-base text-[#757575] font-normal text-left mt-2 ">
              With Indrav, you can purchase any medicine you need and have it
              delivered to your doorstep in just 10 minutes. Our efficient
              delivery system ensures you get your medication when you need it
              the most.
            </span>
            <span className="block text-lg font-semibold text-[#333]">
              Why Choose Indrav for Medicine Delivery?
            </span>
            <ul className="flex text-base flex-col text-[#757575]">
              <li>
                &#8226; Rapid Delivery: Receive your medicines within 10 minutes
                of placing an order.
              </li>
              <li>
                &#8226; Wide Selection: Access a comprehensive range of
                medications from our extensive inventory.
              </li>
              <li>
                &#8226; Easy Ordering: Our intuitive app interface makes it
                simple to find and order your required medicines.
              </li>
            </ul>
