    ...
    return (
        <>
            ...
            <div style={{
                ...
                <span className="text-sm"><span onClick={() => { router.push("/Home"); }} className="hover:text-red_new hover:cursor-pointer text-white">Home</span> <FontAwesomeIcon icon={faAngleRight} />  Doctors</span>
            </div >


            <div className="h-auto w-full shadow-lg bg-white flex justify-center"
                style={{
                ...
                <div className="font-custom justify-center w-[85%] lg:w-[70%] h-full flex flex-col mt-16">
                    ...
                    <div className="flex flex-col md:flex-row w-full h-full items-center md:item ">
                        <div className="h-full w-full md:w-[70%]">
                            <div className="">
                                <span className='w-full text-3xl lg:text-4xl text-[#333] font-bold text-left '>Nexus: The Ultimate Doctor ERP Portal</span>
                                <div className='block w-[10%] h-1 bg-blue_new mt-3'></div>
                            </div>
                            <div className="flex">
                                <span className='w-[100%] sm:w-[80%] text-base text-[#757575] font-normal text-left mt-2 '>Nexus is our comprehensive ERP portal designed to streamline healthcare management for doctors and their receptionists. It empowers medical professionals with a robust set of tools to efficiently manage their practice.</span>
                            </div>
                        </div>
                        <div className="w-[80%] md:w-[45%] xl:w-[35%] h-[120px] md:h-[150px] mt-5 md:mt-0" style={{
                    ...
                    <div className="w-full h-auto flex flex-col my-6 md:my-16 rounded-xl md:bg-white items-center py-10">
                        ...
                        <div className="w-[100%] sm:w-[80%] md:w-[90%] bg-white rounded-xl md:rounded-none md:bg-transparent h-auto md:h-[300px] space-y-3 md:space-y-0 py-4 md:py-0 my-5 md:my-1 flex flex-col md:flex-row justify-center md:justify-end items-center">
                            <div className="w-full md:w-1/2 h-auto  md:h-full flex items-center justify-center">
                                <div className="w-72 h-72 rounded-full bg-red-500" style={{
                                    backgroundImage: 'url("nexus1.jpg")',
                                    backgroundSize: 'cover',
                                    backgroundPosition: 'center',
                                }}></div>
                                <FontAwesomeIcon className="hidden text-4xl text-blue_new pl-5" icon={faChevronRight} />
                            </div>
                            <div className="w-full md:w-1/2 h-auto md:h-full px-5 flex flex-col justify-center items-center">
                                <div className="flex flex-col space-y-2">
                                    <span className="text-2xl lg:text-3xl text-blue_new font-bold w-full">Appointment Management</span>
                                    <span className="text-sm text-[#757575]  font-normal w-full">Effortlessly Track and Schedule Patient Appointments</span>
                                ...
                                <div className='text-[#757575]  h-auto w-full pt-5 text-sm flex flex-col items-center lg:text-base text-left'>
                                    <ul className="space-y-3">
                                        <li>&#8226; Receive notifications for upcoming appointments.</li>
                                        <li>&#8226; Reschedule or cancel appointments with ease.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-[100%] sm:w-[80%] md:w-[90%] bg-white rounded-xl md:rounded-none md:bg-transparent h-auto md:h-[300px] space-y-3 md:space-y-0 py-4 md:py-0 my-5 md:my-1 flex flex-col md:flex-row-reverse justify-center md:justify-end items-center">
                            <div className="w-full md:w-1/2 h-auto  md:h-full flex items-center justify-center">
                                <FontAwesomeIcon className="text-4xl text-blue_new pr-5" icon={faChevronLeft} />
                            ...
                            <div className="w-full md:w-1/2 h-auto md:h-full px-5 flex flex-col justify-center items-center">
                                <div className="flex flex-col space-y-2">
                                    <span className="text-2xl lg:text-3xl text-blue_new font-bold w-full">Prescription Creation</span>
                                    <span className="text-sm text-[#757575]  font-normal w-full">Instantly Generate and Send Detailed Prescriptions</span>
                                    <div className='bg-[#9a9a9a] h-[0.15rem] w-1/4 mt-2'></div>
                                </div>
                                <div className='text-[#757575]  h-auto w-full pt-5 text-sm flex flex-col items-center lg:text-base text-left'>
                                    <ul className="space-y-3">
                                        <li>&#8226; Create accurate and detailed prescriptions quickly.</li>
                                        <li>&#8226; Include dosage instructions and medication details.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-[100%] sm:w-[80%] md:w-[90%] bg-white rounded-xl md:rounded-none md:bg-transparent h-auto md:h-[300px] space-y-3 md:space-y-0 py-4 md:py-0 my-5 md:my-1 flex flex-col md:flex-row justify-center md:justify-end items-center">
                            <div className="w-full md:w-1/2 h-auto  md:h-full flex items-center justify-center">
                                ...
                                <FontAwesomeIcon className="text-4xl text-blue_new pl-5" icon={faChevronRight} />
                            </div>
                            <div className="w-full md:w-1/2 h-auto md:h-full px-5 flex flex-col justify-center items-center">
                                <div className="flex flex-col space-y-2">
                                    <span className="text-2xl lg:text-3xl text-blue_new font-bold w-full">Patient Management</span>
                                    <span className="text-sm text-[#757575]  font-normal w-full">Quickly Access and Manage Patient Information</span>
                                    <div className='bg-[#9a9a9a] h-[0.15rem] w-1/4 mt-2'></div>
                                </div>
                                <div className='text-[#757575]  h-auto w-full pt-5 text-sm flex flex-col items-center lg:text-base text-left'>
                                    <ul className="space-y-3">
                        ...
                        <div className="w-[100%] sm:w-[80%] md:w-[90%] bg-white rounded-xl md:rounded-none md:bg-transparent h-auto md:h-[300px] space-y-3 md:space-y-0 py-4 md:py-0 my-5 md:my-1 flex flex-col md:flex-row-reverse justify-center md:justify-end items-center">
                            ...
                            <div className="w-full md:w-1/2 h-auto md:h-full px-5 flex flex-col justify-center items-center">
                                <div className="flex flex-col space-y-2">
                                    <span className="text-2xl lg:text-3xl text-blue_new font-bold w-full">Seamless Communication</span>
                                    <span className="text-sm text-[#757575]  font-normal w-full">Maintain Direct and Efficient Patient Communication</span>
                                    <div className='bg-[#9a9a9a] h-[0.15rem] w-1/4 mt-2'></div>
                                </div>
                                <div className='text-[#757575]  h-auto w-full pt-5 text-sm flex flex-col items-center lg:text-base text-left'>
                                    <ul className="space-y-3">
                                        <li>&#8226; Send instant messages and updates to patients.</li>
                                        <li>&#8226; Receive patient queries and respond promptly.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
