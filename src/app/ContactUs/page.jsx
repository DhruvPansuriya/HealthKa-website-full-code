            ...
            <div className="bg-slate-50 w-full h-auto py-16  flex flex-col justify-center items-center font-custom  text-[#333]">
                <div className="bg-white w-[90%] sm:w-[500px] md:w-[85%] lg:w-[80%] xl:w-[70%] h-auto shadow-xl flex flex-col md:flex-row">
                    <div style={{
                        ...
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                    }} className="bg-red-100 w-full md:w-[50%] h-[300px] md:h-[550px] lg:h-[500px] xl:h-[550px]" ></div>
                    ...
                    <div className=" bg-white w-full md:w-[50%] h-auto md:h-full flex flex-col items-start justify-around p-5 sm:p-10" >
                        ...
                        <span className="text-sm mt-2" >If you have any questions please fell free to contact with us.</span>
                        ...
                        <form className="h-auto w-full flex flex-col items-center pt-6 xl:pt-12">
                            <div className="grid grid-cols-1 md:grid-cols-2 place-items-center w-full  ">
                                <input type="text" placeholder="Name" name="Name" className="border rounded-md outline-none m-2 h-12  p-2 w-[100%] md:w-[95%]" />
                                <input type="text" placeholder="Email" name="Email" className="border rounded-md outline-none m-2 h-12  p-2 w-[100%] md:w-[95%]" />
                                <input type="text" placeholder="Phone" name="Phone" className="border rounded-md outline-none h-12 m-2 p-2 w-[100%] md:w-[95%]" />
                                <input type="text" placeholder="Subject" name="Subject" className="border rounded-md outline-none h-12 m-2 p-2 w-[100%] md:w-[95%]" />
                                <textarea type="text" placeholder="Your Message" className="visible md:hidden border rounded-md outline-none m-2 p-2 h-28 w-[100%] md:w-[95%]" />
                                <button type="submit" className="visible md:hidden border rounded-md bg-blue_new h-10 w-[100%] m-2 text-white">Send</button>
                            </div>
                            <textarea type="text" placeholder="Your Message" className="hidden md:block border rounded-md outline-none  h-28 w-[97%] m-2 p-2" />
                            <button type="submit" className="hidden md:block border rounded-md bg-blue_new h-10 w-[97%] m-2 text-white">Send</button>
